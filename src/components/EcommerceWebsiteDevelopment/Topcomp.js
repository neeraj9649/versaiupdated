...
import HeroImage from "./Images/ecommerce.png";
...
const TopComp = () => {
  ...
  return (
    <section className="w-full bg-[#f7f5f8] flex px-6 md:px-20 lg:px-36 py-14 md:py-28">
      <div
      ...
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#050748] font-bold mb-4">
            Ecommerce Plateform Development
          </h1>
