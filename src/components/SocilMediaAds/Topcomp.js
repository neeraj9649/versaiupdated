...
import heroImage from './Images/advertisement.png'; // Ensure the correct path to your image
...
const TopComp = () => {
  ...
  return (
    <section className="w-full flex px-6 bg-sky-50 md:px-20 lg:px-36 py-14 md:py-28">
      <div
