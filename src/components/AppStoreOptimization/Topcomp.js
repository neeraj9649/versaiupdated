...
import heroImage from './Images/APPseo.png'; // Ensure the correct path to your image
...
const TopComp = () => {
  ...
  return (
    <section className="w-full bg-[#f0f7fa] flex px-6 md:px-20 lg:px-36 py-14 md:py-28">
      <div
